...
create index gfgx_dmsj_dlbm_btress on "GFGX_Y_DMK_DMSJ" using btree("DLBM");  -- 27.631s
create index gfgx_dmsj_dmmccd_btress on "GFGX_Y_DMK_DMSJ" using btree("DMMCCD");  -- 20.09s
create index gfgx_dmsj_lv_btress on "GFGX_Y_DMK_DMSJ" using btree("LV");  -- 16.73s
create index gfgx_dmsj_dmbs_btress on "GFGX_Y_DMK_DMSJ" using btree("DMBS");  -- 15.122s
create index gfgx_dmsj_dmmc_gin ON "GFGX_Y_DMK_DMSJ" using gin ("DMMC" gin_trgm_ops); -- 448.224s
create index gfgx_dmsj_dmmc_btree on "GFGX_Y_DMK_DMSJ" using btree("DMMC" collate "C"); -- 28.327s
create index gfgx_dmsj_wz_gist on "GFGX_Y_DMK_DMSJ"  using gist("WZ"); -- 379.939s

create index pcc_geom_gist  on "pg_province_city_county"  using gist("geom");  
create index world_geom_gist  on "world"  using gist("geom"); 

-------可加----
create index pcc_code_btree  on "pg_province_city_county"  using btree("code");  
create index world_name_gin  on "world"  using gin("name" gin_trgm_ops); 
create index world_name_btree on "world" using btree("name" collate "C"); 
```
...
create index gfgx_dmsj_dlbm_btress on "GFGX_Y_DMK_DMSJ" using btree("DLBM");  -- 16.169
